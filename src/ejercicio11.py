...
def informacion_directorio(texto):
    #Divide el texto en lineas y extrae los nombres de los campos
    lineas = texto.strip().split('\n')
    campos = lineas[0].split(';')
    clientes = {}

    #Itera sobre las lineas con informacion de clientes
    for linea in lineas[1:]:
        datos = linea.split(';')
        cliente = {}
        #Asocia cada campo con su valor en el cliente
...
if __name__ == '__main__':
    ...
    for nif, cliente in clientes_diccionario.items():
